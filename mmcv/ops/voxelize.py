...
class _DynamicVoxelization(Function):
...
dynamic_voxelization = _DynamicVoxelization.apply
...
class DynamicVoxelization(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        return dynamic_voxelization(input, self.voxel_size, self.point_cloud_range,
                            self.max_num_points, max_voxels,
                            self.deterministic)
